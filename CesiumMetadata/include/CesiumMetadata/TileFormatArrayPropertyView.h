...
public:
  ...
  virtual gsl::span<const uint8_t> getInstanceAsUint8(size_t instance) const override;

  virtual gsl::span<uint8_t> getInstanceAsUint8(size_t instance) override;

  virtual gsl::span<const int8_t> getInstanceAsInt8(size_t instance) const override;

  virtual gsl::span<int8_t> getInstanceAsInt8(size_t instance) override;

  virtual gsl::span<const uint16_t> getInstanceAsUint16(size_t instance) const override;

  virtual gsl::span<uint16_t> getInstanceAsUint16(size_t instance) override;

  virtual gsl::span<const int16_t> getInstanceAsInt16(size_t instance) const override;

  virtual gsl::span<int16_t> getInstanceAsInt16(size_t instance) override;

  virtual gsl::span<const uint32_t> getInstanceAsUint32(size_t instance) const override;

  virtual gsl::span<uint32_t> getInstanceAsUint32(size_t instance) override;

  virtual gsl::span<const int32_t> getInstanceAsInt32(size_t instance) const override;

  virtual gsl::span<int32_t> getInstanceAsInt32(size_t instance) override;

  virtual gsl::span<const uint64_t> getInstanceAsUint64(size_t instance) const override;

  virtual gsl::span<uint64_t> getInstanceAsUint64(size_t instance) override;

  virtual gsl::span<const int64_t> getInstanceAsInt64(size_t instance) const override;

  virtual gsl::span<int64_t> getInstanceAsInt64(size_t instance) override;

  virtual gsl::span<const float> getInstanceAsFloat(size_t instance) const override;

  virtual gsl::span<float> getInstanceAsFloat(size_t instance) override;

  virtual gsl::span<const double> getInstanceAsDouble(size_t instance) const override;
